                                        ...
                                        <div class="col-lg-12">
                                            @foreach ($paymentPlatforms as $payment)
                                                ...
                                                @else
                                                    ...
                                                    @endif
                                                    @if ($payment->slug == 'mollie')
                                                        <div class="form-group">
                                                            <div class="form-check card-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="payment" id="mollie" value="mollie" />
                                                                <label class="form-check-label"
                                                                    for="mollie">{{ $payment->name }}</label>
                                                                <div class="input-icon">
                                                                    <img src="{{ asset(IMG_PAYMENT_GATEWAY . $payment->image) }}"
                                                                        alt="mollie" />
                                                                </div>
                                                    ...
                                                    @if ($payment->slug == 'paystack')
                                                        <div class="form-group">
                                                            <div class="form-check card-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="payment" id="paystack" value="paystack" />
                                                                <label class="form-check-label"
                                                                    for="paystack">{{ $payment->name }}</label>
                                                                <div class="input-icon">
                                                                    <img src="{{ asset(IMG_PAYMENT_GATEWAY . $payment->image) }}"
                                                                        alt="paystack" />
                                                                </div>
                                                    ...
                                                    @endif
                                                    @if ($payment->slug == 'instamojo')
                                                        <div class="form-group">
                                                            <div class="form-check card-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="payment" id="instamojo" value="instamojo" />
                                                                <label class="form-check-label"
                                                                    for="instamojo">{{ $payment->name }}</label>
                                                                <div class="input-icon">
                                                                    <img src="{{ asset(IMG_PAYMENT_GATEWAY . $payment->image) }}"
                                                                        alt="instamojo" />
                                                                </div>
