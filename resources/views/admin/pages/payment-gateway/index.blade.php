                    ...
                    <form enctype="multipart/form-data" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            @if ($pg->slug == 'mollie')
                                <div class="input__group mb-25">
                                    <label for="exampleInputEmail1">{{ __('Key') }}</label>
                                    <input type="text" name="mollie_key" value="{{ env('MOLLIE_KEY') }}">
                                </div>
                            @endif
                            @if ($pg->slug == 'paystack')
                                <div class="input__group mb-25">
                                    <label for="exampleInputEmail1">{{ __('Key') }}</label>
                                    <input type="text" name="paystack_public_key" value="{{ env('PAYSTACK_PUBLIC_KEY') }}">
                                </div>
                                <div class="input__group mb-25">
                                    <label for="exampleInputEmail1">{{ __('Secret') }}</label>
                                    <input type="text" name="paystack_secret_key" value="{{ env('PAYSTACK_SECRET_KEY') }}">
                                </div>
                            @endif
                            @if ($pg->slug == 'instamojo')
                                <div class="input__group mb-25">
                                    <label for="exampleInputEmail1">{{ __('Api Key') }}</label>
                                    <input type="text" name="im_api_key" value="{{ env('IM_API_KEY') }}">
                                </div>
                                <div class="input__group mb-25">
                                    <label for="exampleInputEmail1">{{ __('Auth Token') }}</label>
                                    <input type="text" name="im_auth_token" value="{{ env('IM_AUTH_TOKEN') }}">
                                </div>
                            @endif
                            @if ($pg->slug == 'bank')
                                <div class="input__group mb-25">
